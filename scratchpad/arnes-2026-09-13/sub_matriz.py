...
out=root/'Relatorio Auditoria 2026-09-12'/'conclusao-2026-09-13'/'matriz-espaco'
...
plano=[]
for video in ['ja-longo','en-conversa']:
 for mode in ['studio','job']:
  for diar in ['off','sortformer']: plano.append((mode,video,'apple',diar))
plano.append(('job','ja-musica','whisper','sortformer'))
plano.append(('job','ja-musica','qwen','sortformer'))
